...
for (
  var i$jscomp$inline_1807 = 0;
  i$jscomp$inline_1807 < simpleEventPluginEvents.length;
  i$jscomp$inline_1807++
) {
  var eventName$jscomp$inline_1808 =
      simpleEventPluginEvents[i$jscomp$inline_1807],
    domEventName$jscomp$inline_1809 =
      eventName$jscomp$inline_1808.toLowerCase(),
    capitalizedEvent$jscomp$inline_1810 =
      eventName$jscomp$inline_1808[0].toUpperCase() +
      eventName$jscomp$inline_1808.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1809,
    "on" + capitalizedEvent$jscomp$inline_1810
  );
}
...
if (
  "19.2.0-www-modern-3e20dc8b-20250820" !==
...
var internals$jscomp$inline_2694 = {
  bundleType: 0,
  version: "19.2.0-www-modern-3e20dc8b-20250820",
  rendererPackageName: "react-dom",
  currentDispatcherRef: ReactSharedInternals,
  reconcilerVersion: "19.2.0-www-modern-3e20dc8b-20250820"
};
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2695 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2695.isDisabled &&
    hook$jscomp$inline_2695.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2695.inject(
        internals$jscomp$inline_2694
      )),
        (injectedHook = hook$jscomp$inline_2695);
    } catch (err) {}
}
